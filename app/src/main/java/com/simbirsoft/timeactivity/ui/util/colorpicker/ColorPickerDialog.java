...
package com.simbirsoft.timeactivity.ui.util.colorpicker;
 ...
 *
 * source: https://android.googlesource.com/platform/frameworks/opt/colorpicker/+/android-5.0.2_r1
 */
public class ColorPickerDialog extends DialogFragment implements ColorPickerSwatch.OnColorSelectedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mAlertDialog = new MaterialDialog.Builder(activity)
            .title(mTitleResId)
